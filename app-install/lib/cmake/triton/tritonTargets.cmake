...
foreach(_cmake_expected_target IN ITEMS triton::triton)
...
# Create imported target triton::triton
add_library(triton::triton SHARED IMPORTED)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/tritonTargets-*.cmake")
