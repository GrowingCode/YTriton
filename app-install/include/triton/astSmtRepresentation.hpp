     ...
     */
      ...
      class AstSmtRepresentation : public AstRepresentationInterface {
        public:
          ...
          //! Displays the node according to the representation mode.
          TRITON_EXPORT std::ostream& print(std::ostream& stream, triton::ast::FpsubNode* node);
          ...
          //! Displays the node according to the representation mode.
          TRITON_EXPORT std::ostream& print(std::ostream& stream, triton::ast::To_fp32Node* node);

          //! Displays the node according to the representation mode.
          TRITON_EXPORT std::ostream& print(std::ostream& stream, triton::ast::To_fp64Node* node);

          //! Displays the node according to the representation mode.
          TRITON_EXPORT std::ostream& print(std::ostream& stream, triton::ast::FpisZeroNode* node);

          //! Displays the node according to the representation mode.
          TRITON_EXPORT std::ostream& print(std::ostream& stream, triton::ast::FpisPositiveNode* node);
