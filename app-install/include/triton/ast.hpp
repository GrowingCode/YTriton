 ...
 */
   ...
   */
    ...
    //! `(fpsub <expr1> <expr2>)` node
    class FpsubNode : public AbstractNode {
    private:
      TRITON_EXPORT void initHash(void);

    public:
      TRITON_EXPORT FpsubNode(const SharedAbstractNode& expr1, const SharedAbstractNode& expr2);
      TRITON_EXPORT void init(bool withParents = false);
    };
    ...
    //! `(_ to_fp32  <expr>)` node
    class To_fp32Node : public AbstractNode {
    private:
      TRITON_EXPORT void initHash(void);

    public:
      TRITON_EXPORT To_fp32Node(const SharedAbstractNode& expr);
      TRITON_EXPORT void init(bool withParents = false);
    };


    //! `(_ to_fp64  <expr>)` node
    class To_fp64Node : public AbstractNode {
    private:
      TRITON_EXPORT void initHash(void);

    public:
      TRITON_EXPORT To_fp64Node(const SharedAbstractNode& expr);
      TRITON_EXPORT void init(bool withParents = false);
    };


    //! `(_ FpisZeroNode  <expr>)` node
    class FpisZeroNode : public AbstractNode {
    private:
      TRITON_EXPORT void initHash(void);

    public:
      TRITON_EXPORT FpisZeroNode(const SharedAbstractNode& expr);
      TRITON_EXPORT void init(bool withParents = false);
    };


    //! `(_ FpisPositive  <expr>)` node
    class FpisPositiveNode : public AbstractNode {
    private:
      TRITON_EXPORT void initHash(void);

    public:
      TRITON_EXPORT FpisPositiveNode(const SharedAbstractNode& expr);
      TRITON_EXPORT void init(bool withParents = false);
    };
