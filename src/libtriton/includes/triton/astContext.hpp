 ...
 */
   ...
   */
    ...
    class AstContext : public std::enable_shared_from_this<AstContext> {
      ...
      public:
        ...
        //! AST C++ API - fpsub node builder
        TRITON_EXPORT SharedAbstractNode fpsub(const SharedAbstractNode& expr1, const SharedAbstractNode& expr2);
  ...
  /*        std::cout << "NodeStr: " << NodeStr << std::endl;*/
        ...
        //! AST C++ API - to_fp32 node builder
        TRITON_EXPORT SharedAbstractNode to_fp32(const SharedAbstractNode& expr);

        //! AST C++ API - to_fp64 node builder
        TRITON_EXPORT SharedAbstractNode to_fp64(const SharedAbstractNode& expr);

        //! AST C++ API - fpisZero node builder
        TRITON_EXPORT SharedAbstractNode fpisZero(const SharedAbstractNode& expr);

        //! AST C++ API - fpisZero node builder
        TRITON_EXPORT SharedAbstractNode fpisPositive(const SharedAbstractNode& expr);
