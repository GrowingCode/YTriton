     ...
     */
      ...
      class SymbolicEngine
        ...
        public:
          ...
          //! Returns the AST corresponding to the register and defines the register as input of the instruction.
          TRITON_EXPORT triton::ast::SharedAbstractNode getFp32Ast(const triton::arch::Register& reg);

          //! Returns the AST corresponding to the register and defines the register as input of the instruction.
          TRITON_EXPORT triton::ast::SharedAbstractNode getFp64Ast(const triton::arch::Register& reg);
