  ...
  namespace ast {
    ...
    z3::expr TritonToZ3::do_convert(const triton::ast::SharedAbstractNode& node, std::unordered_map<triton::ast::SharedAbstractNode, z3::expr>* results) {
      ...
      switch (node->getType()) {
        ...
        case To_fp32_NODE:
          return to_expr(this->context, Z3_mk_fpa_to_fp_bv(this->context, children[0], this->context.fpa_sort(8, 24)));

        case To_fp64_NODE:
          return to_expr(this->context, Z3_mk_fpa_to_fp_bv(this->context, children[0], this->context.fpa_sort(11, 53)));

        case FPSUB_NODE:
          return to_expr(this->context, Z3_mk_fpa_sub(this->context, this->context.fpa_rounding_mode(), children[0], children[1]));

        case FpisZero_NODE:
          return to_expr(this->context, Z3_mk_fpa_is_zero(this->context, children[0]));

        case FpisPositive_NODE:
          return to_expr(this->context, Z3_mk_fpa_is_positive(this->context, children[0]));
