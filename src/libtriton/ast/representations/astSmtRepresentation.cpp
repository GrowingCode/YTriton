    ...
    namespace representations {
      ...
      std::ostream& AstSmtRepresentation::print(std::ostream& stream, triton::ast::AbstractNode* node) {
        switch (node->getType()) {
          ...
          case FPSUB_NODE:                return this->print(stream, reinterpret_cast<triton::ast::FpsubNode*>(node)); break;
          ...
          case To_fp32_NODE:              return this->print(stream, reinterpret_cast<triton::ast::To_fp32Node*>(node)); break;
          case To_fp64_NODE:              return this->print(stream, reinterpret_cast<triton::ast::To_fp64Node*>(node)); break;
          case FpisZero_NODE:             return this->print(stream, reinterpret_cast<triton::ast::FpisZeroNode*>(node)); break;
          case FpisPositive_NODE:         return this->print(stream, reinterpret_cast<triton::ast::FpisPositiveNode*>(node)); break;
      ...
      /* fpsub representation */
      std::ostream& AstSmtRepresentation::print(std::ostream& stream, triton::ast::FpsubNode* node) {
        stream << "(fp.sub roundNearestTiesToEven" << node->getChildren()[0] << " " << node->getChildren()[1] << ")";
        return stream;
      }
      ...
      /* to_fp32 representation */
      std::ostream& AstSmtRepresentation::print(std::ostream& stream, triton::ast::To_fp32Node* node) {
        stream << "((_ to_fp 8 24) "  << node->getChildren()[0] << ")";
        return stream;
      }

      /* to_fp64 representation */
      std::ostream& AstSmtRepresentation::print(std::ostream& stream, triton::ast::To_fp64Node* node) {
        stream << "((_ to_fp 11 53) " << node->getChildren()[0] << ")";
        return stream;
      }

      /* fpisZero representation */
      std::ostream& AstSmtRepresentation::print(std::ostream& stream, triton::ast::FpisZeroNode* node) {
        stream << "(fp.isZero " << node->getChildren()[0] << ")";
        return stream;
      }

      /* fpisPositive representation */
      std::ostream& AstSmtRepresentation::print(std::ostream& stream, triton::ast::FpisPositiveNode* node) {
        stream << "(fp.isPositive " << node->getChildren()[0] << ")";
        return stream;
      }
